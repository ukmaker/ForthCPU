...
module tb;
    ...
    dpram u1 (.DataInA(DataInA), .DataInB(DataInB), .AddressA(AddressA), 
    ...
    begin
      ...
      @(WrA == 1'b1);
      @(WrA == 1'b0);
      for (i10 = 0; i10 < 19; i10 = i10 + 1) begin
        @(posedge ClockA);
      end
      for (i10 = 0; i10 < 19; i10 = i10 + 1) begin
        @(posedge ClockB);
