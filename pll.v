...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll -lang verilog -synth synplify -arch xo3c00a -type pll -fin 20 -fclkop 10 -fclkop_tol 1.0 -trimp 0 -phasep 0 -trimp_r -bypasss2 -bypass_divs2 -fclkos2 0.15625 -bypasss3 -bypass_divs3 -fclkos3 0.15625 -phase_cntl STATIC -fb_mode 1 -lock  */
/* Tue Sep 12 18:06:20 2023 */


`timescale 1 ns / 1 ps
module pll (CLKI, CLKOP, CLKOS2, CLKOS3, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS2;
    output wire CLKOS3;
    ...
    defparam PLLInst_0.CLKOS3_CPHASE = 127 ;
    defparam PLLInst_0.CLKOS2_FPHASE = 0 ;
    defparam PLLInst_0.CLKOS2_CPHASE = 127 ;
    ...
    defparam PLLInst_0.VCO_BYPASS_C0 = "ENABLED" ;
    ...
    defparam PLLInst_0.CLKOS3_DIV = 128 ;
    defparam PLLInst_0.CLKOS2_DIV = 128 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATI0(scuba_vlo), .CLKOP(CLKOP_t), .CLKOS(), .CLKOS2(CLKOS2_t), 
        ...
        .PLLDATO3(), .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS3="0.156250" */
             /* synthesis FREQUENCY_PIN_CLKOS2="0.156250" */
             /* synthesis FREQUENCY_PIN_CLKOP="10.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS3 0.156250
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 0.156250
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 10.000000
